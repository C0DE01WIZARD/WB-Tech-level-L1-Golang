...
func main(){
	...
	// Устанавливаем количество горутин, которые должны быть завершены передаём длину слайса
	//Мы запускаем столько горутин, сколько элементов, содержится в слайсnumbers
	wg.Add(len(numbers))
