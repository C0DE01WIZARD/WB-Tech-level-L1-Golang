...
func setBit(num int64, pos, value int) int64 {
    if value == 1 {
        ...
        return num | (1 << pos) // Использование побитовой операции "| ИЛИ" для установки бита в значение 1
    }
		
    return num &^ (1 << pos) // Использование побитовой операции И (&) c отрицанием (^) для установки бита в значение 0
}
